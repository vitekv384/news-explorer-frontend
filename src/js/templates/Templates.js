    ...
    popup_signin: `
      <div class="popup__content">
        ...
        <form class="popup__form" name="sign_in">
          ...
          <span class="popup__error popup__error_hiden">Неправильный формат email</span>
          ...
          <span class="popup__error popup__error_hiden">Неправильный формат пароля</span>
    ...
    popup_signup: `
      <div class="popup__content">
        ...
        <form class="popup__form" name="sign_up">
          ...
          <span class="popup__error popup__error_hiden">Такой пользователь уже есть</span>
